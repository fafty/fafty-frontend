            ...
            <div className="flex justify-between items-center  py-4 md:justify-start align-center">
              ...
              <div className="hidden md:flex items-center justify-end">
                ...
                <div className="flex items-center">
                  <Popover className="relative mr-5 flex align-center">
                    {({ open }) => (
                      <>
                        <Popover.Button>
                          <div className="flex -space-x-1 overflow-hidden border rounded-full p-0.5 items-center">
                            <img
                              className="inline-block h-6 w-6 rounded-full ring-2 ring-white mr-3"
                              src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                              alt=""
                            />
                            <span className="pr-3 text-sm">7.0034</span>
                            <span className="text-sm text-green-600 pr-1">ETH</span>
                          </div>
                        </Popover.Button>
