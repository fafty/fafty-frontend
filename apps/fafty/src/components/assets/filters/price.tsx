  ...
  return (
    <div className="flex flex-col relative">
      ...
      <div className="py-2">
        <button
          type="button"
          className="font-medium text-gray-900 dark:text-gray-50 bg-gray-200 dark:bg-neutral-700 hover:bg-gray-300 mb-1 w-full rounded-[7px] px-2 py-2 focus:outline-none transition duration-150 ease-in-out"
          onClick={onSave}
        >
          Save
        </button>
