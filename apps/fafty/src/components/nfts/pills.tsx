    ...
    <div className="flex">
      <div className="flex items-center gap-[8px]">
        {queryPills?.map(({ title, value }) => (
          <div
            key={value}
            className="flex relative justify-between  text-center bg-blue-600 border border-transparent rounded-md py-3 pl-4 pr-8 font-medium text-white hover:bg-blue-700"
          >
            {title}
            <div
