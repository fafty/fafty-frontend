...
const AccountAssets = () => {
      ...
      >
        ...
        <div className="flex items-center justify-left">
          <div className="flex flex-col">
            ...
            <div className="w-[5rem] h-[0.75rem] mt-1 bg-neutral-300 dark:bg-neutral-700 rounded-sm animate-pulse" />
          </div>
        </div>
        <div className="flex items-center justify-left">
  ...
  const renderMasonry = useMemo(() => {
    ...
    return (
      <List
        className="relative grid grid-cols-[minmax(300px,_400px)_minmax(100px,_120px)_minmax(70px,_100px)_minmax(100px,_120px)_minmax(100px,_120px)_minmax(100px,_120px)] gap-x-1 mx-auto w-full"
        items={items}
        role="list"
        rowGutter={0}
        render={({ data }) => {
