...
const SelectStep4 = ({ Context }: { Context: Context<ContextProps> }) => {
  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <div className="my-5">
        <p className="text-sm">
          We will check to see if the cover image contains violations that could restrict its publication. If it turns out that the file does not meet the requirements, you can take action before it is published.
      ...
      <div>
        <p className="text-xs text-neutral-400">
          Keep in mind that only a preliminary check is carried out during the uploading phase. If there are violations in your cover image, they may be detected later.
