...
const SelectStep4 = ({ Context }: { Context: Context<ContextProps> }) => {
  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <div className="my-5">
        <p className="text-sm">
          We will check to see if the file contains violations that could
      ...
      <div className="space-beetwen my-8 flex items-center justify-center">
      ...
      <div>
        <p className="text-xs text-neutral-400">
          ...
          uploading phase. If there are violations in your file, they may be
          detected later.
