...
export default function Dropdown({
  ...
  return (
    <>
      ...
      >
        <div
          className={ `${showDropDown ? 'bg-blue-100 dark:bg-neutral-600' : ''} ${buttonClassName}` }
        ...
        >
          ...
          <ArrowDropDownIcon className="w-4 h-4 fill-gray-600 dark:fill-gray-50" aria-hidden="true" />
        </div>
      </div>
      ...
      { showDropDown && element &&
        createPortal(
          <div className="absolute z-20 left-1/2 transform -translate-x-1/2 mt-1">
            <div aria-label="Format text" role="dialog" className="dropdown z-10" ref={dropDownRef}>
