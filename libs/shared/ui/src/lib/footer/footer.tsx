...
const Footer = () => {
  return (
    <>
      <footer className="bg-white dark:bg-neutral-800  text-slate-900  dark:text-slate-50 border-t border-gray-100 dark:border-neutral-700 pt-20 lg:pt-[120px] pb-10 lg:pb-20 relative z-10">
