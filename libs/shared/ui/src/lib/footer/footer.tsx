          ...
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <Link
                ...
                target="_blank"
              >
                <div className="m-t font text-4xl font-extrabold tracking-tight text-slate-900  dark:text-slate-50  sm:text-4xl">
                  Fafty
                </div>
              </Link>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                <Link
                  href="https://www.facebook.com/fafty.official"
                  rel="nofollow noopener"
                  target="_blank"
                ...
                <Link
                  href="https://www.twitter.com/fafty.official"
                  rel="nofollow noopener"
                  target="_blank"
                  className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                ...
                <Link
                  href="https://www.youtube.com/channel/UCbHKQtm7niP4nr8gQ_jcS7w"
                  rel="nofollow noopener"
                  target="_blank"
                  className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
              ...
              <p className="text-body-color text-base">&copy; 2022 Fafty</p>
            </div>
          </div>
        </div>
      </div>
