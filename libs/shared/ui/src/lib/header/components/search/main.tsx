...
import { useAsync, getSearchResult } from '@fafty/shared/api'
import {
    ...
    <div className="relative mx-4 w-full max-w-[600px]" ref={containerRef}>
      <div className="flex items-center">
        <div className="h-[50px] w-full">
          ...
          >
            <kbd className="flex items-baseline rounded-sm border-[1px] border-gray-200 bg-gray-50 px-2.5 font-sans font-semibold dark:border-neutral-700 dark:bg-neutral-600/50">
              <abbr
                aria-label="Open using /"
                title="Command"
                className="no-underline opacity-80"
              >
                ∕
              </abbr>
            </kbd>
